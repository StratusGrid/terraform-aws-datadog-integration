...
This project is based on [Scribd's Terraform AWS Datadog](https://github.com/scribd/terraform-aws-datadog) module.
...
```
module "datadog" {
  source                = "https://github.com/StratusGrid/terraform-aws-datadog-integration"
  version               = "~>1"
