...
variable "dd_forwarder_log_retention_in_days" {
  type        = number
  default     = 90
  description = "Defines the log retention period (in days) for CloudWatch logs generated by the DataDog Log Forwarder."
}
